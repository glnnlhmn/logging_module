...
# FIXME: Add import and create logger with formatters and handles
def play_again():
...
def hangman(word):
    ...
    while count < limit:
        ...
        if guess in guessed:
            ...
            # FIXME: Add logger for already guessed letter
            continue
        ...
        if guess in letters:
            ...
            # FIXME: Add logger for correct guess
        else:
            guessed.append(guess)
            count += 1
            # FIXME: Add logger for wrong guess
            if count == 1:
                time.sleep(1)
                print(
                    "   _____ \n"
...
def play_hangman():
    ...
    # Fixme: Add logger for name

    time.sleep(1)
    print("The game is about to start!\nLet's play Hangman!")
    time.sleep(1)
    # FIXME: Add logger for starting the game
    ...
    # FIXME: Add logger for ending the game
    exit()
